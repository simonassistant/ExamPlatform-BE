...
In this section, you will read one academic passage and answer 11 questions.
Questions may be multiple choice, fill in the blanks, or true/false/not given.

You will have 20 minutes to complete this section. The timer will start when you click "Start Section".

You cannot return to a test section after submission. Please review all answers carefully before submitting each section, as changes are not allowed once submitted.

When you are ready, click 'Start Section' to begin.
...
- 1 cloze summary (fill-in-the-blank) question
...
<audio id="examAudio" preload="auto">
  <source src="https://ep-paper-file.oss-cn-hongkong.aliyuncs.com/test_01/listening/listening_audio1.mp3" type="audio/mpeg">
...
<audio id="examAudio" preload="auto">
  <source src="https://ep-paper-file.oss-cn-hongkong.aliyuncs.com/test_01/listening/listening_audio2.mp3" type="audio/mpeg">
  The browser does not support the audio element.
</audio>

Answer the following questions according to the dialog 2.
...
It is true that understanding your personality type is effective for your own personal (1)_______ and gives guidelines for how you should interact with others.  
However, refrain from (2)______ putting personality tests results on résumé and cover letters. 


_What if a company asks for my MBTI in the job advertisement?_ 
Take (3)_____ and consider why they are asking. Does the company use the information for employee development or simply as a (4) _______ to screen applicants? 

_What should I do instead?_ 

We recommend focusing on doing the following: 

[i] Showcase elements that employers value, for example your (5) _______ skills 

[ii] Provide concrete (6) ________ for your experiences e.g., internships, volunteer work. 
...
<audio id="examAudio" preload="auto">
  <source src="https://ep-paper-file.oss-cn-hongkong.aliyuncs.com/test_01/writing/writing_audio.mp3" type="audio/mpeg">
  The browser does not support the audio element.
</audio>
