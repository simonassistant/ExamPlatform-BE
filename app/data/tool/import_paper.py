...
def import_paper():
    ...
    print(f'Parse paper {paper_dto.paper_id}: {len(paper_dto.sections)} sections, {len(paper_dto.questions)} questions')
    ...
    for section_dto in paper_dto.sections:
        ...
        for question_dto in section_dto.questions:
            if question_dto.question_type is None and section_dto.question_type is not None:
                question_dto.question_type = section_dto.question_type
            if question_dto.score is None and section_dto.unit_score is not None:
                question_dto.score = section_dto.unit_score
            ...
            print(f'Save question {question_dto.seq} to Database')
